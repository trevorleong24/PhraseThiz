...
// Fetch the latest score for each student for the grammar quiz (quiz_id = QZ01)
$quiz_id = "QZ01"; // Grammar quiz ID
$sql = "
    SELECT 
        sq.student_quiz_id,
        s.username,
...
<head>
    ...
    <link rel="stylesheet" href="../css/grammar-instructor-result.css">
</head>
<body>
    <header class="header">
    ...
    <main class="main">
        <h1 class="title">Grammar Quiz Result</h1>
        <div class="box-container">
            <div class="results-container">
                <?php if (count($results) > 0): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <p>No results available for the grammar quiz.</p>
                <?php endif; ?>
            </div>
        </div>
