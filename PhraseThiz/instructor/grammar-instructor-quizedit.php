...
<head>
    ...
    <title>Add Grammar Quiz Question</title>
...
<main>
    <section class="form-container">
        <h1>Add Grammar Quiz Question</h1>
        ...
        <button class="back-button" onclick="window.location.href='../instructor/grammar-instructor.php'">Back</button>
    </section>
</main>
<footer>
