...
$sql_quiz = "SELECT quiz_id, title, description FROM quiz WHERE title = 'Vocabulary Quiz'";
...
<head>
    ...
    <title>PhraseThiz - Vocabulary Quiz</title>
    <link rel="stylesheet" href="../css/vocabulary-instructor.css">
</head>
<body>
<header class="header">
...
<section class="quiz-container">
    ...
    <div class="quiz-box">
        ...
        <div class="quiz-info-box">
            ...
            <button class="edit-quiz-btn" onclick="editQuiz()">Edit Quiz</button>
            <button class="view-result-btn" onclick="viewResult()">View Result</button>
        </div>
    </div>
</section>
