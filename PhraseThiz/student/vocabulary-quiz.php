...
$quiz_id = "QZ02"; // Replace with your actual quiz ID if needed
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($current_question_index + 1 >= count($questions)) {
        ...
        $next_url = "../student/vocabulary-result.php";
    } else {
        // Move to next question
        $next_index = $current_question_index + 1;
        $next_url = "../student/vocabulary-quiz.php?index=$next_index";
    }
}
...
<head>
    ...
    <link rel="stylesheet" href="../css/vocabulary-quiz.css">
</head>
<body>
<header class="header">
...
<div class="container" style="display: flex; align-items: center; justify-content: center;">
    ...
    <form id="quiz-form" method="POST" action="../student/vocabulary-quiz.php?index=<?php echo $current_question_index; ?>" style="flex: 2; text-align: center;">
